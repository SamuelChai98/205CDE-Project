				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12">
							...
							<h2 style="margin-top:-24px; margin-bottom:18px; margin-left: 30px;">New Quotation</h2>
							<!--Quotation Details Input Section-->
							<div id="filter">
								<div class="row">
									<div class="col-xs-12">
										<h3 style="text-indent:30px; margin-bottom:25px;">Quotation #21034</h3>
									</div>
								</div>
								<div class="row">
								...
								<div id="save-footer">
									<button type="button" onclick="window.location.href='customer quotation.php'" class="btn btn-primary btn-md" id="save-button">Save</button>
								</div>
							</div>
							<!--Modal-->
